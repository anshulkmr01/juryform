	...
	<!-- Search Bar -->
		<div class="container-fluid margin-top-25">
			<div class="container">
				<div class="row">
			<div class="col-sm-8">
					<a data-toggle="modal" class="open-updateFields btn btn-primary btn-sm" href="#adddeadline">Add Deadline</a>
			</div>
			<div class="col-sm-3">
	...
	<div class="container-fluid table categories-table">
		...
		<div class="container">
			...
			<table id="myTable" class="sortable-table">
				<?= form_open('admin/set_deadlines/AdminController/deleteSelectedDeadlines'); ?>
				<tr class="sorter-header">
					...
					<?php
						...
						<td>
							<?= anchor("admin/set_deadlines/AdminController/deleteDeadline/{$deadline->ID}",'Delete',['class'=>'delete btn btn-danger']); ?>
						</td>
