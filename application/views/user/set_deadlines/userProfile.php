				...
				<?php if(!$isGooogleConnected){?>
					...
					<div id="myTabContent" class="tab-content">
					  <div class="tab-pane fade active show" id="holidays">
					  	<div class="row">
					   <div class="col-sm-4">
						<?= form_open('set_deadlines/addHoliday'); ?>
						  <fieldset>
								...
								if($holidays) {
									...
									foreach ($holidays as $holiday) {
										?>
											...
											<td><a href="<?= base_url('set_deadlines/deleteHoliday/'.$holiday->ID)?>" class="delete" style="color: #e70808; font-weight: 900"> Delete</a></td>
											</tr>
										<?php
									}
									echo "</table>";
						...
						<?= form_open('changePassword'); ?>
						  <fieldset>
						    ...
						    <div class="form-group">
						      ...
						      <?= form_input(['placeholder'=>'Current Password','required'=>'required','name'=>'currentPassword','class'=>'form-control','id'=>'currentPassword','aria-describedby'=>'currentPassword']); ?>
							  <?= form_error('currentPassword');?>
						  	</div>

						    <div class="form-group">
						      <label for="password">New Password*</label>
						      <?= form_input(['placeholder'=>'New Password','required'=>'required','name'=>'newPassword','class'=>'form-control','id'=>'newPassword','aria-describedby'=>'newPassword']); ?>
						      <small id="newPassword" class="form-text text-muted"></small>
