	...
	<div class="container-fluid table categories-table">
		...
		<div class="container">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">My Rules</li>
			</ol>
			...
			<table id="myTable" class="sortable-table">
				...
				<tr class="sorter-header">
					...
					<?php
						...
						<td>
							<?= anchor("set_deadlines/user_rules/userDeadlines/{$rule->ID}",'Deadlines',['class'=>'btn btn-primary']); ?>
						</td>
						<td>
						...
						<td>
							<?= anchor("user/set_deadlines/MainController/dublicateRule/{$rule->ID}",'Duplicate',['class'=>'btn btn-primary']); ?>
						</td>
						<td>
							<?= anchor("user/set_deadlines/MainController/deleteUserRule/{$rule->ID}",'Delete',['class'=>'delete btn btn-danger']); ?>
						</td>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
			  ...
			  <fieldset>
				...
				<?= form_open('set_deadlines/addUserRule'); ?>
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
					  ...
					  <fieldset>
						...
						<?= form_open('set_deadlines/editUserRule'); ?>
