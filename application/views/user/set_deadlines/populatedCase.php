...
<body>
	...
	<!-- Search Bar -->
		<div class="container-fluid margin-top-25">
			...
			<div class="row">
			<div class="col-sm-6">
				<form method="post" action="<?= base_url('set_deadlines/searchCasesForDate')?>">
					<div class="row">
	...
	<div class="container-fluid table categories-table borderless">
		...
		<div class="container">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><?=anchor('set_deadlines/user_cases','Cases')?></li>
			...
			<table id="myTable" class="sortable-table">
				...
				<tr>
				<td>
					<a href="<?= base_url('set_deadlines/populatedRules/'.$case->ID)?>"><?= $case->caseTitle?></a>
				</td>
				<td>
				...
				<td>
					<?= anchor("set_deadlines/deleteSavedDeadline/{$deadline->ID}/{$deadline->deadlineGoogleID}",'Delete',['class'=>'btn btn-danger delete']);?>
				</td>
				</tr>
