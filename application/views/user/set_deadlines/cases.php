	...
	<div class="container-fluid table categories-table">
		...
		<div class="container">
			...
			<table id="myTable" class="sortable-table">
				<?= form_open('set_deadlines/deleteSelectedCases'); ?>
				<tr class="sorter-header">
					...
					<?php
						...
						<td>
							<?= anchor("set_deadlines/listedRules/{$case->ID}/?case={$case->title}","Add Event", ['class'=>'btn btn-primary'])?>
						</td>
						<!-- 
						<td>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
			  ...
			  <fieldset>
				...
				<?= form_open('set_deadlines/addCase'); ?>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
			  ...
			  <fieldset>
				...
				<?= form_open('set_deadlines/editCase'); ?>
			    <div class="form-group margin-top-25">
			      <label for="caseTitle">Title*</label>
