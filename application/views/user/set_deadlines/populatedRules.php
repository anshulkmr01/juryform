	...
	<div class="container-fluid categories-home">
		<div class="container">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="<?=base_url('set_deadlines/see_all_events')?>">Saved Deadlines</a></li>
				<li class="breadcrumb-item active"><?= $rules->caseTitle?></li>
			</ol>

			<legend class="pull-left">Case: <?= $rules->caseTitle?></legend>
			<span class="pull-right"><?= anchor("set_deadlines/deleteSavedCase/{$rules->ID}",'Delete',['class'=>'delete btn btn-danger btn-sm']);?></span>
